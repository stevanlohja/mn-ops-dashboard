...
You should have already generated a network key in the previous step [Install Midnight Node and Generate Validator Keys](/docs/fno-guides/preprod/install-node-and-keys).
...
- **Peer ID**: You node's network Peer ID.
